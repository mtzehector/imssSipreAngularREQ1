...
import { OrigenSolicitud } from 'src/app/common/origen.solicitud';
import { EstadoSolicitud } from 'src/app/common/domain';
...
export class InformeMontoLiquidarComponent extends BaseComponent implements OnInit {
  ...
  registroExitoso(cartaInstruccion: CartaInstruccion) {
    ...
    console.log(">>>BITACORA", JSON.stringify(bitacora));
